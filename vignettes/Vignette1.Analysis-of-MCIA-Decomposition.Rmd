...
The results contain several outputs from the decomposition:
...
```{r part-1-visualize-clusters, fig.dim = c(5, 5), fig.align = 'center'}
...
```{r part-1-visualize-clusters-color-col, fig.dim = c(5, 5), fig.align = 'center'}
...
```{r part-2-block-heatmap, fig.dim = c(4.5, 3), fig.align = 'center'}
...
This analysis can be repeated as necessary to make sense of other gene based 
factor loadings.
