...
The NCI60 data set has been included with the `nipalsMCIA` package:
...
The result is an object of the `NipalsResult` class containing several outputs from the decomposition:
