...
```
In the heatmap above, the samples have been hierarchically clustered. To further understand these clusters it is useful to add some color_col which is availble
throught the `color_col` parameter as shown below:
