...
### Computing the decomposition via the Non-Linear Iterative Partial Least Squares (NIPALS) algorithm

*Max, feel free to change title*  

Todo:  

1. Motivate NIPALS - compare to original Omicade procedure  
2. Brief outline of algorithm  
3. Note that deflation process has a parameter that modifies MCIA to CPCA  

## Resources

*Add references*

## Notes on data pre-processing and normalization

*A.K. will add notes here*
