...
The `coloring` argument of `MCIA_plots()` can then be used to determine which column of `metadata` is used for coloring the projection plots, in this case the column is `cancerType`:
