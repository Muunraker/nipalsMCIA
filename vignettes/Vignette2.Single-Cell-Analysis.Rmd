...
pb_download(file = "data_blocks_sc_seurat.Rds", repo = "Muunraker/nipalsMCIA", 
            tag = "v0.0.1", dest = file.path("..", "inst", "extdata"))
pb_download(file = "data_sc_sce.Rdata", repo = "Muunraker/nipalsMCIA", 
            tag = "v0.0.1", dest = file.path("..", "inst", "extdata"))

# Seurat files
pb_download(file = "tenx_pbmc5k_CITEseq_annotated.rds", repo = "Muunraker/nipalsMCIA", 
            tag = "v0.0.1", dest = file.path("..", "inst", "extdata"))
pb_download(file = "tenx_pbmc5k_CITEseq_processed.rds", repo = "Muunraker/nipalsMCIA", 
            tag = "v0.0.1", dest = file.path("..", "inst", "extdata"))
pb_download(file = "tenx_pbmc5k_CITEseq_raw.rds", repo = "Muunraker/nipalsMCIA", 
            tag = "v0.0.1", dest = file.path("..", "inst", "extdata"))
```
...
# load(file = file.path("..", "inst", "extdata", "data_sc_sce.Rdata"))

# load the Seurat object formatted for MCIA
# compare with the previous file!
data_blocks_sc_seurat <- readRDS(file = file.path("..", "inst", "extdata", 
...
save(data_blocks_sc_sce, data_blocks_sc_sce_seurat, 
     file = file.path("..", "data", "data_sc_sce.Rda"))

# these two files can be found as "data_sc_sce.Rdata" on piggyback
```
...
obj <- readRDS(file = file.path("..", "inst", "extdata", "tenx_pbmc5k_CITEseq_annotated.rds"))
...
md <- read.csv(file.path("..", "data", "metadata_sc.csv"))
md2 <- read.csv(file.path("..", "data", "metadata_sc_edel.csv"))
...
saveRDS(mcia_results_sc, file = file.path("..", "inst", "extdata", "mcia_results_sc_seurat.Rds"))
``` 
...
```{r, message = FALSE}
# load the data
obj <- readRDS(file = file.path("..", "inst", "extdata", "tenx_pbmc5k_CITEseq_raw.rds"))
...
```{r}
obj <- readRDS(file.path("..", "inst", "extdata", "tenx_pbmc5k_CITEseq_processed.rds"))
```
