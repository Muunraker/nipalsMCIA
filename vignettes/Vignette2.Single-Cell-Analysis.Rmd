...
![Flow Chart](https://github.com/Muunraker/nipalsMCIA/releases/download/v0.99.0/Vignette-2-Pipeline.png)
...
```{r data-all-list}
# list all of the currently available data in v0.99.0
pb_list(repo = "Muunraker/nipalsMCIA", tag = "v0.99.0")
```

```{r data-all-download}
# files for running MCIA
pb_download(file = "metadata_sc.csv", # "Annotations"
            repo = "Muunraker/nipalsMCIA", tag = "v0.99.0", dest = path_inst)
