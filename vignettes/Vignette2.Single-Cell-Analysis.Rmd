...
# external images for the vignette
path_image <- file.path(".", "images")
```

```{r flowchart, echo = FALSE}
# download the flowchart
pb_download(file = "Vignette-2-Pipeline.png", # created with Whimsical
            repo = "Muunraker/nipalsMCIA", tag = "v0.0.1", dest = path_image)
