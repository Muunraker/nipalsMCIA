...
#' @slot block_scores A list of matrices. Each matrix contains the scores as columns for a given block.
#' @slot block_loadings A list of matrices. Each matrix contains the loadings as columns for a given block.
#' @slot eigvals A list of singular values of the data matrix at each deflation step. 
#' @slot col_preproc_method character for the column-level preprocessing method used. See `col_preproc()`.
#' @slot block_preproc_method character for the block-level preprocessing method used. See `block_preproc()`.
#' @slot block_variances A list of variances for each block. 
#' @slot metadata A data frame of metadata originally passed into `nipals_multiblock()`.
#' 
#' @name NipalsResult
#' @rdname NipalsResult
#' @export
